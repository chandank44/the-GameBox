...
<div class="row">
	...
	<div class="col-md-8">
		<img class="img-responsive center-block" src="<c:url value="/resources/images/${product.id}.jpg"/>" style="width:100px;height:100px" alt="1"/>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-10">
	<form:input class="form-control" path="procat"/>
	</div>
</div>
<div class="form-group">
